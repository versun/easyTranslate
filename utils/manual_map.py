...
print("Start........")
stable_ts = {
    "myMemory": {"name": "MyMemory", "priority": 100},
    "alibaba": {"name": "Alibaba", "priority": 100},
    "baidu": {"name": "Baidu", "priority": 100},
    "modernMt": {"name": "ModernMT", "priority": 100},
    "iciba": {"name": "Iciba", "priority": 100},
    "google": {"name": "Google", "priority": 100},
    "bing": {"name": "Bing", "priority": 100},
    "lingvanex": {"name": "Lingvanex", "priority": 100},
    #"yandex": {"name": "Yandex", "priority": 100},
    "itranslate": {"name": "Itranslate", "priority": 100},
    "sysTran": {"name": "SysTran", "priority": 100},
    "argos": {"name": "ArgoS", "priority": 100},
    "reverso": {"name": "Reverso", "priority": 100},
    "deepl": {"name": "DeepL", "priority": 100},
    "cloudTranslation": {"name": "Cloud Translation", "priority": 100},
    "qqTranSmart": {"name": "QQ Translate Smart", "priority": 100},
    "translateCom": {"name": "Translate Com", "priority": 100},
    "sogou": {"name": "Sogou", "priority": 100},
    "qqFanyi": {"name": "QQ Fanyi", "priority": 100},
    "papago": {"name": "Papago", "priority": 100},
    "youdao": {"name": "Youdao", "priority": 100},
    "iflyrec": {"name": "iFlyrec", "priority": 100},
    "caiyun": {"name": "Caiyun", "priority": 100},
}
...
def get_lang_name(code):
    try:
        ...
        return pool_mapping.get(lang.display_name(), lang.language_name()) # 用于不同格式的code对应的相同语言
    except Exception:
        return None
lang_map = {}
for t, detail in stable_ts.items():
    print("Mapping ",t)
    lang_map[t] = {
        get_lang_name(code): code
        for code in ts.get_languages(t)
        if get_lang_name(code) in Support_Language
    }
